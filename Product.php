...
<head>
    ...
    <link rel="stylesheet" href="./CSS Files/productdetail.css">
...
<body>
    ...
    <!-- main work -->
    <section class="main">
        <h2 class="p-2 mb-0 w-100">See all Products</h2>
        <!-- cards box -->
        <div class="cards">
            <?php
            ...
            ?>
                    <div class="card">
                        <div class="content">
                            <div class="front">
                                <div class="image">
                                    <img src='Images/<?php echo $row["ProductProfile"]; ?>' alt='Product Image'>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="buttons">
                                    ...
                                    if (isset($_SESSION["username"])) {
                                        if ($row['ProductInstock'] == 1) {
                                            echo '<button type="button" class="btn btn-primary order-button" data-product-id="' . $row['ProductId'] . '">Order</button>';
                                        } else {
                                            echo '<p style="border: 1px solid; padding: 4px; width: 120px">Available soon</p>';
                                        }
                                        echo '<button type="button" class="btn btn-primary openDetail" onclick="openDetail(' . $i . ')">Details</button>';
                                    }
                                    ?>
                                    <button type="button" class="btn btn-primary"><a href="Description.php">Description</a></button>
                                </div>
                            </div>
                        </div>
                        <div class="detailbox detailbox<?php echo $i; ?>">
                            <button type="button" class="btn-close" aria-label="Close" onclick="closeDetail(<?php echo $i; ?>)"></button>
                            <h4>Details</h4>
                            <div class="row r1">
